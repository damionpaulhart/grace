<?php
 $title="Edit Insepctor";
 require_once 'header.php';


	$editID = $_REQUEST["id"];
	$result = mysql_query("SELECT * FROM users WHERE user_id = $editID" ) or die(mysql_error());
				...
				<table border="0" cellpadding="8">
								<tr>
												<td align="right"><label for="user_name">Registered Inspector</label>
																<input type="text" class="input" style="width:200px" name="user_name"  id="user_name" <?php echo 'value="' . $row['user_name'] . '"'; ?>>
								</tr>
								<tr>
