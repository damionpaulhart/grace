...
<form action="<?php if (!$formViewer) {echo 'form-save.php';}; ?>" method="post" name="<?php echo $form_name ?>" id="<?php echo $form_name ?>" <?php if($formViewer) { echo 'class="formViewer"'; } ?>>
  ...
  <table width="768px" border="0" cellpadding="8">
    <tr>
    <td colspan="3" class="center"><h2>PRESSURE RETEST - HYDROSTATIC METHOD</h2></td>
    </tr>
    
  <tr>
    <td colspan="3" class="center">In Accordance with 49CFT Part 180 Para. 180.407[g] and 180.417)</td>
    </tr>
  ...
  <tr>
      <td colspan="3">Normal Vents Tested
        ...
        <label>
          ...
          No</label>
          <label>
          <input type="radio" name="RadioGroupVent" value="3"  id="RadioGroupVent_2" <?php if($formViewer) { if ($row['RadioGroupVent']=='3') {echo 'checked';};}; ?>>
          Replaced</label></td>
    </tr>
  <!- ROW8 --------------------------------------------------------------------->
  <tr>
      <td colspan="3">
      	<p>Complete this procedure for each compartment. Remove plug and red flag all vents that relieve at less than test pressure.</p>
          ...
          <tr>
            <td nobreak align="left">Bench test all reclosing vents removed from tank</td>
		  ...
		  <tr>
            <td nobreak align="left">Pull vacuum test on emergency valve and discharge valve to determine seal integrity before filling tank (RECOMMENDED, NOT REQUIRED)</td>
		  ...
		  <tr>
            <td nobreak align="left">Close internal valve, leaving discharge calve open.<br>
            				Close manhole cover and install test fitting at top of tank.<br>
            				Fill with water or other liquid having similar viscosity to top of dome cover. <br>
            				Temperature of liquid shall not exceed 100&deg;F.<br>
            				Open dump valve on test fitting and start pressurizing tank.<br>
            				When water begins to flow from dump valve, close valve and bring tank to full test pressure. Hold at prescribed test pressure for at least 10 minutes and inspect for leakage or bulging.</td>
		  ...
		  <tr>
            <td nobreak align="left">Upper coupler must be dropped to inspect the frame, crossmembers and area of shell and heads that may be covered by the upper coupler.<br>
            				<label>Upper Coupler removed</label>
        <label>
          <input type="radio" name="RadioGroupCoupleRemov" value="yes"  id="RadioGroupCoupleRemov_0" <?php if($formViewer) { if ($row['RadioGroupCoupleRemov']=='yes') {echo 'checked';};}; ?>>
          Yes</label>
        <label>
          <input type="radio" name="RadioGroupCoupleRemov" value="no"  id="RadioGroupCoupleRemov_1" <?php if($formViewer) { if ($row['RadioGroupCoupleRemov']=='no') {echo 'checked';};}; ?>>
          No</label></td>
